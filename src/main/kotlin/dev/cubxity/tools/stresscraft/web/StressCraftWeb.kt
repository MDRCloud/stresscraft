...
object StressCraftWeb {
    private val app = AtomicReference<StressCraft?>(null)
    ...
    fun start() {
        // Force key resolution/logging at boot rather than on first request.
        apiKey
        ...
        embeddedServer(Netty, port = 8080, host = "0.0.0.0") {
            ...
            routing {
                ...
                post("/api/start") {
                    ...
                    if (!app.compareAndSet(null, instance)) {
                ...
                post("/api/stop") {
                    ...
                    val running = app.getAndSet(null) ?: run {
